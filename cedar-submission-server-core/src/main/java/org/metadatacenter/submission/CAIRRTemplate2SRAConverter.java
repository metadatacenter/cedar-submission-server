...
public class CAIRRTemplate2SRAConverter
{
    ...
    throws DatatypeConfigurationException, JAXBException
  {
    ...
    contactOrganization.setRole("Data submiiter"); // TODO
    ...
    for (BioSample1 bioSample : cairrInstance.getBioSample1()) {
      ...
      // Descriptor
      JAXBElement descriptionElement = new JAXBElement(new QName("p"), String.class, "AIRR (myasthenia gravis) data to the NCBI using the CAIRR"); // TODO
      ...
      sampleDescriptor.setTitle("AIRR (myasthenia gravis) data to the NCBI using the CAIRR"); // XXX: Hard-coded due to no corresponding entry in
      // the AIRR instance
   ...
   // Ethnicity
    String EthnicityValue = bioSample.getEthnicity().getValue();
     ...
     String PriorTherapiesForPrimaryDiseaseUnderStudyValue = bioSample.getPriorTherapiesForPrimaryDiseaseUnderStudy().getValue();
   ...
   // Processing Protocol
    ...
    for (SequenceReadArchive1 sequenceReadArchive : cairrInstance.getSequenceReadArchive1()) {
      ...
      // File
      for (SRAMultipleFileUploadAttributes1 sraFileUploadAttribute : sequenceReadArchive.getSRAMultipleFileUploadAttributes1()) {
