...
public class CAIRRTemplateInstance2SRAXMLConverter {
  ...
  public String convertTemplateInstanceToXML(CAIRRTemplate cairrInstance)
    ...
    Submission.Description submissionDescription = createSubmissionDescription(cairrInstance);
   ...
   */
  private Submission.Description createSubmissionDescription(CAIRRTemplate cairrInstance) throws
      DatatypeConfigurationException, ParseException {

    final BioProjectForAIRRNCBI cairrBioProject = cairrInstance.getBioProjectForAIRRNCBI();
