...
public class NcbiCairrConstants {
  ...
  protected static final String[] BIOPROJECT_FIELDS = {BIOPROJECT_STUDY_ID_FIELD,
      BIOPROJECT_CONTACT_INFO_FIELD, BIOPROJECT_LAB_NAME_FIELD};
  ...
  protected static final String[] BIOSAMPLE_FIELDS = {
  ...
  protected static final String[] BIOSAMPLE_REQUIRED_FIELD_VALUES = {
      BIOSAMPLE_SUBJECT_ID_FIELD,
      BIOSAMPLE_SYNTHETIC_LIBRARY_FIELD,
      BIOSAMPLE_ORGANISM_FIELD,
      BIOSAMPLE_SEX_FIELD,
  ...
  protected static final String[] SRA_FIELDS = {
      SRA_SAMPLE_ID_FIELD,
  ...
  protected static final String[] SRA_REQUIRED_FIELD_VALUES = SRA_FIELDS;
