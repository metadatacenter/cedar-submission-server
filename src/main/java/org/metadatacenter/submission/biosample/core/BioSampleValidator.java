...
public class BioSampleValidator
{
  ...
  private final AMIA2016DemoBioSampleTemplate2BioSampleSubmissionConverter amia2016DemoBioSampleTemplate2BioSampleSubmissionConverter;

  public BioSampleValidator()
  {
    this.amia2016DemoBioSampleTemplate2BioSampleSubmissionConverter = new AMIA2016DemoBioSampleTemplate2BioSampleSubmissionConverter();
  }
    ...
    throws IOException, JAXBException, DatatypeConfigurationException
  {
    ...
    String submissionXML = this.amia2016DemoBioSampleTemplate2BioSampleSubmissionConverter
      .generateBioSampleSubmissionXMLFromAMIA2016DemoBioSampleInstance(amia2016DemoBioSampleSubmissionInstance);
