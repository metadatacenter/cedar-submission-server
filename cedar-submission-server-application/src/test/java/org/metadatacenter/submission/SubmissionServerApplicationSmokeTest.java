 ...
 * cannot see.
 */
public class SubmissionServerApplicationSmokeTest {

  @ClassRule
  public static final DropwizardAppRule<SubmissionServerConfiguration> SERVER =
      new DropwizardAppRule<>(SubmissionServerApplication.class, ResourceHelpers.resourceFilePath("test-config.yml"));
